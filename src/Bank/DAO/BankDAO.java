...
public class BankDAO { 
 public static boolean createAccount(Bank b) { 
  ...
  String create = "INSERT INTO USERS23 VALUES(0,?,?,?,?,?)"; 
  int res = 0; 
  try { 
 ...
 public static Bank getDetails(Bank b) { 
  ...
  PreparedStatement ps = null; 
  ResultSet rs = null; 
  String data = "SELECT * FROM USERS23 WHERE ACCNO = ? AND PIN = ?"; 
  try { 
   con = Connector.connect(); 
 ...
 public static int updatePin(int acc, String pass) { 
  Connection con = null; 
  PreparedStatement ps = null; 
  String updatepin = "UPDATE USERS23 SET PIN = ? WHERE ACCNO = ?"; 
  int res = 0; 
  try { 
   con = Connector.connect(); 
 ...
 public static int getBal(int acno) { 
  ...
  ResultSet rs = null; 
  int balance = 0; 
  String data = "SELECT * FROM USERS23 WHERE ACCNO = ?"; 
  try { 
   con = Connector.connect(); 
   ps = con.prepareStatement(data); 
   ps.setInt(1, acno); 
 ...
 public static int updateBal(int acc, int bal) { 
  Connection con = null; 
  PreparedStatement ps = null; 
  String updateBal = "UPDATE USERS23 SET BALANCE = ? WHERE ACCNO = ?"; 
  int res = 0; 
  try { 
   con = Connector.connect(); 
